...
const machineData = {
  ...
  // 小役確率・通常時のベース
  'small-role':
    '【悪揃い（リプレイ）】約1/8で出現。悪図柄が一直線に停止するリプレイに相当する役で、あらゆるシーンの出玉の起点となる。\n\n' +
    '【通常時のベース】詳細な小役確率・押し順ベルの確率などは調査中。ベル成立時にシンテツドウポイントを獲得し（上段・右下がりベルで1pt減算、小Vベルで2pt減算）、ポイント0到達でCZ抽選を行う。\n\n' +
    '【チャンス目】チャンス目①（リプレイ）：中段に【悪/悪/ベル】が停止。チャンス目②・③（15枚）：運命図柄が小山または小Vに停止。運命揃い（15枚）：約1/7282、運命図柄が右上がりor右下がり一直線に停止するプレミアフラグ。',
  'small-role-img': '',

  // ロングフリーズと運命揃い
  'long-freeze':
    '【ロングフリーズ】チャンス目成立時の一部で前兆を経由して発生。エピソードボーナス「不老不死の秘密」に当選し、ボーナス消化後に特化ゾーン「極悪ドライブ」＆上位AT「超S級アクダマドライブ」に突入！？\n\n' +
    '【運命揃い（プレミアフラグ）】運命図柄が右上がりor右下がり一直線に停止（青/赤図柄どの組み合わせでも有効）。出現率は約1/7282。\n\n' +
    '恩恵（通常時）：CZ「運命チャンス」に当選。その他の状況での恩恵は調査中。',
  'long-freeze-img': `${R2}/l_akudama_drive_ekishou03.webp`,
